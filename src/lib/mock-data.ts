...
export const mockHealthRecords: HealthRecord[] = [
  { id: 'R001', name: 'Juan Dela Cruz', age: 45, gender: 'Male', address: 'Purok 1', disease: 'Hypertension', vaccinationStatus: 'Vaccinated', checkupDate: '2023-05-10' },
  { id: 'R002', name: 'Maria Santos', age: 32, gender: 'Female', address: 'Purok 2', disease: 'None', vaccinationStatus: 'Vaccinated', checkupDate: '2023-05-11' },
  { id: 'R003', name: 'Peter Tan', age: 68, gender: 'Male', address: 'Purok 1', disease: 'Diabetes', vaccinationStatus: 'Partially Vaccinated', checkupDate: '2023-05-12' },
  { id: 'R004', name: 'Anna Gomez', age: 25, gender: 'Female', address: 'Purok 3', disease: 'None', vaccinationStatus: 'Vaccinated', checkupDate: '2023-05-12' },
  { id: 'R005', name: 'Jose Rodriguez', age: 51, gender: 'Male', address: 'Purok 2', disease: 'Hypertension', vaccinationStatus: 'Not Vaccinated', checkupDate: '2023-05-13' },
  { id: 'R006', name: 'Liza Soberano', age: 28, gender: 'Female', address: 'Purok 3', disease: 'Asthma', vaccinationStatus: 'Vaccinated', checkupDate: '2023-05-14' },
  { id: 'R007', name: 'Enrique Gil', age: 72, gender: 'Male', address: 'Purok 1', disease: 'Diabetes', vaccinationStatus: 'Vaccinated', checkupDate: '2023-05-15' },
  { id: 'R008', name: 'Kathryn Bernardo', age: 5, gender: 'Female', address: 'Purok 4', disease: 'None', vaccinationStatus: 'Partially Vaccinated', checkupDate: '2023-05-15' },
  { id: 'R009', name: 'Daniel Padilla', age: 8, gender: 'Male', address: 'Purok 4', disease: 'None', vaccinationStatus: 'Not Vaccinated', checkupDate: '2023-05-16' },
  { id: 'R010', name: 'James Reid', age: 30, gender: 'Male', address: 'Purok 2', disease: 'None', vaccinationStatus: 'Vaccinated', checkupDate: '2023-05-17' },
];
